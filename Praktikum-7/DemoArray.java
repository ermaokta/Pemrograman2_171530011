public class DemoArray { //membuat class baru dengan nama DemoArray dan modifier public
    public static void main(String[] args) { //membuat method main yang berfungsi sebagai method yang pertama kali dijalankan
        System.out.println("\nContoh 1\n");
        ...
        System.out.println("\n\nContoh 2\n");
        int nilai[] = {75, 80, 90, 100}; //deklarasi variabel array dengan nama nilai dan tipe data int dan memiliki panjang array 4 dan langsung diinisialisasika
